...
//即時計算當月人數
const arr = [188, 571, 213, 132,518,270];
...
var chart = c3.generate({
    ...
    data: {
        x: 'x',
        columns: [
            ['x', '2023-10-31', '2023-11-30', '2023-12-31', '2024-01-31', '2024-02-29','2024-03-31','2024-04-30'],
            ['每月人數', 188, 571, 213, 132, 518, 270,`${result - Arrresult}`],
            ['總數', 188, 759, 912, 1104,1622,1892,result],
