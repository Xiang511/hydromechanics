...
//即時計算當月人數
const arr = [188, 571, 213, 132,518,270,255,219,193,70,170];
...
var chart = c3.generate({
    ...
    data: {
        x: 'x',
        columns: [
            ['x','2023-10-31', '2023-11-30', '2023-12-31', '2024-01-31', '2024-02-29','2024-03-31','2024-04-30','2024-05-31','2024-06-30','2024-07-31','2024-08-31','2024-09-30'],
            ['每月瀏覽人數', 188, 571, 213, 132, 518, 270,255,219,193,70,170,`${result - Arrresult}`],
            ['瀏覽總數', 188, 759, 912, 1104,1622,1892,2147,2366,2559,2629,2849 ,result],
